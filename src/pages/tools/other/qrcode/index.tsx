...
export default function Qrcode() {
  ...
  const generateQr = async () => {
    ...
    configData.data = qrContent;

    qr.setOptions(configData);
    // 调用制作二维码方法
    qr.make();
    // 获取canvas上下文
    ...
    <div>
      ...
      <MyCard title={"二维码生成"} icon={<EditOutlined />}>
        ...
        <div className={"flex w-full justify-end items-center"}>
          <Button onClick={generateQr} type={"primary"} size={"large"}>
            生成二维码
          </Button>
        </div>
      </MyCard>
        ...
        <div>
          <MyCard title={"二维码图像"} icon={<EditOutlined />}>
            <div className={"flex justify-center items-center"}>
              <canvas
                ref={qrCanvas}
                width={configData.size}
                height={configData.size}
              ></canvas>
            </div>
          </MyCard>
          ...
          <MyCard title={"高级设置"} icon={<EditOutlined />}>
            <div className="flex justify-start items-center w-full mb-4">
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  <div
                    className="w-full cursor-pointer flex justify-between items-center borderSolid"
                    style={{ border: "1px solid #d9d9d9" }}
                  >
                    <div>{configData.areaColor}</div>
                    <div
                      className="w-4 h-4 mr-1"
                      style={{ backgroundColor: configData.areaColor }}
                    ></div>
                  </div>
                </Popover>
              </div>
              ...
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  <div className="w-full cursor-pointer flex justify-between items-center borderSolid">
                    ...
                    <div
                      className="w-4 h-4 mr-1"
                      style={{ backgroundColor: configData.separatorColor }}
                    ></div>
                  </div>
                </Popover>
              </div>
              ...
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="w-4 h-4 mr-1"
                      style={{ backgroundColor: configData.foregroundColor }}
                    ></div>
                  </div>
                </Popover>
              </div>
              ...
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="w-4 h-4 mr-1"
                      style={{ backgroundColor: configData.darkBlockColor }}
                    ></div>
                  </div>
                </Popover>
              </div>
                ...
                <Popover
                  content={
                    <SketchPicker
                      ...
                      onChange={(res) => {
                        setConfigData({
                          positionProbeBackgroundColor: res.hex,
                        });
                      }}
                    />
                  }
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor:
                          configData.positionProbeBackgroundColor,
                      }}
                    ></div>
                  </div>
                </Popover>
                ...
                <Popover
                  content={
                    <SketchPicker
                      ...
                      onChange={(res) => {
                        setConfigData({
                          positionProbeForegroundColor: res.hex,
                        });
                      }}
                    />
                  }
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor:
                          configData.positionProbeForegroundColor,
                      }}
                    ></div>
                  </div>
                </Popover>
            ...
            <div className={"mb-4"}>
              ...
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  {configData.backgroundImageSrc ? (
                    <img
                      src={configData.backgroundImageSrc}
                      alt="avatar"
                      style={{ width: "100%" }}
                    />
                  ) : (
              ...
              {configData.backgroundImageSrc == "" ? (
                <div>
                  <div className="flex mb-1">
                    <div className="w-1/6 text-center leading-8">
                      背景图片宽度：
                    </div>
                    <Slider
                      min={0}
                  ...
                  <div className="flex mb-1">
                    <div className="w-1/5 text-center leading-8">
                      背景图片位置X坐标：
                    </div>
                    <Input
                      className={"w-4/5"}
            ...
            <div className={"mb-4"}>
              ...
              <div className="flex justify-start items-center w-1/4">
                ...
                >
                  {configData.foregroundImageSrc ? (
                    <img
                      src={configData.foregroundImageSrc}
                      alt="avatar"
                      style={{ width: "100%" }}
                    />
                  ) : (
              ...
              <div>
                (前景图面积+边距填充最大不能超过对应容错率的二维码面积，否则会影响识别)
              </div>
                      ...
                      <Popover
                        content={
                          <SketchPicker
                            ...
                            onChange={(res) => {
                              setConfigData({
                                foregroundImageBackgroundColor: res.hex,
                              });
                            }}
                          />
                        }
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor:
                                configData.foregroundImageBackgroundColor,
                            }}
                          ></div>
                        </div>
                      </Popover>
                      ...
                      <Popover
                        content={
                          <SketchPicker
                            ...
                            onChange={(res) => {
                              setConfigData({
                                foregroundImageShadowColor: res.hex,
                              });
                            }}
                          />
                        }
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor:
                                configData.foregroundImageShadowColor,
                            }}
                          ></div>
                        </div>
                      </Popover>
